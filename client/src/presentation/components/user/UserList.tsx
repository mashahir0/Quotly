...
//   // Load users on component mount & when search changes
//   useEffect(() => {
//     setUsers([]); // Reset users when search changes
//     setPage(1);
//     setHasMore(true);
//     triggerGetUsers({ search, page: 1 });
//   }, [search]);

//   // Append new users to the list when data updates
//   useEffect(() => {
//     if (data) {
...
//           triggerGetUsers({ search, page: page + 1 });
//         }
//       });
